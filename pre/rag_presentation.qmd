...
# Implementation & Key Features {data-name='Implementation'}
Speaker: Yuting Fan

## Implementation Details {auto-animate="true"}
### Document Retrieval
...
![](images/UI.png){fig-align="center" width="1000"}

[Contextual Retrieval Augmented Generation (RAG) System](https://yuting-fan-265-rag-system-rag-app-new-v1sxnc.streamlit.app)
...
- For abolishing the free System of English Laws in a neighbouring Province, establishing therein an Arbitrary government, and enlarging its Boundaries so as to render it at once an example and fit instrument for introducing the same absolute rule into these Colonies:
  - (Score: -9.223430633544922)
- For suspending our own Legislatures, and declaring themselves invested with power to legislate for us in all cases whatsoever.
  - (Score: -10.269696235656738)
- For depriving us in many cases, of the benefits of Trial by Jury:
  - (Score: -11.189470291137695)
```
